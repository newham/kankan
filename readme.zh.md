...
**0.3.0**|2020.07.19|新增功能：<br>1.新增拖拽支持，将图片拖拽至窗口即可打开！<br>2.新增对eps格式的支持.<br>3.修复浏览大图时y轴出现滚动条的bug.<br>4.修复欢迎界面无法移动的bug.|[0.3.0.dmg.zip](https://github.com/newham/kankan/releases/download/v0.3.0/kankan-0.3.0.dmg.zip)
